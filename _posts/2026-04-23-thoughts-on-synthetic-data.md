...
The UK uses synthetic data. Scalable, privacy-preserving, increasingly the default.

Taiwan's national health system uses federated learning. The model goes to the data. Privacy preserved, outcomes improved, training data that reflects the population it serves.
...
Federated learning, synthetic data, boosting — none are perfect alone. Together, with honest accounting of who's absent and why, they start to look like a real framework.
